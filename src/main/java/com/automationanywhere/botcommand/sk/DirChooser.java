...
@BotCommand
@CommandPkg(label="Directory Chooser", name="DirChooser", description="Choose File",  icon="jfx.svg",comment = true , text_color = "#00bbbb" , background_color =  "#00bbbb",
...
public class DirChooser  {
  ...
  private  void initFX() throws Exception {
	  ...
	  scene.getStylesheets().add(url.toExternalForm());
 	  ...
 	  textElement.textProperty().addListener((obs, oldText, newText) -> 
		this.dirname= newText
      );
