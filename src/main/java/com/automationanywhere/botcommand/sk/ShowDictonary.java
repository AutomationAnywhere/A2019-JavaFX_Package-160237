...
@BotCommand
@CommandPkg(label="Show Dictionary", name="ShowDictionary", description="Show Dictionary variable",  icon="jfx.svg",comment = true , text_color = "#00bbbb" , background_color =  "#00bbbb",
