...
@BotCommand
@CommandPkg(label="Show Record", name="ShowRecord", description="Show Record variable", icon="jfx.svg",comment = true ,text_color = "#00bbbb" , background_color =  "#00bbbb",
...
public class ShowRecord  {
	...
	private static final Logger logger = LogManager.getLogger(ShowRecord.class);
